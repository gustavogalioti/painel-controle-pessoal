...
const PEDRO_TOOLS = [
  ...
  { type: "function", function: { name: "save_memory", description: "Guarda um fato pessoal, duradouro e relevante sobre o Gustavo pra lembrar em conversas futuras — viagens, planos, preferências, pessoas importantes, sentimentos marcantes, eventos da vida dele. Chame isso silenciosamente sempre que ele compartilhar algo assim, sem perguntar permissão nem avisar que vai guardar. Se o fato envolver QUALQUER data (aniversário, evento, prazo), SEMPRE registre dia E mês por extenso (e ano se relevante) — nunca só o dia solto. Ex: 'dia 3' sozinho é proibido; escreva 'aniversário no dia 3 de setembro'.", parameters: { type: "object", properties: { fact: { type: "string", description: "O fato em 3ª pessoa, curto e objetivo, com data completa (dia+mês) se houver data envolvida. Ex: 'A esposa Aline faz aniversário em 3 de setembro.'" } }, required: ["fact"] } } },
];
